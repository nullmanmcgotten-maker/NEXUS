...
This repository now includes a live-data-ready engine shell for Binance Futures. It is intentionally strict and safety-first.

What is included:
- Binance Futures REST adapter for market data and account access
- risk governor with risk caps and kill switches
- execution manager with live-order gating
- engine loop that checks connectivity, builds a snapshot, and approves or rejects a trade
